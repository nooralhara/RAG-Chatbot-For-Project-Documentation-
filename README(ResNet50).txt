...
A ResNet50 pretrained model with ImageNet weights
    ...
    • Two Phase Training :
        ...
        2. Unfreeze the last 30 layers of the backbone and fine-tune with a lower learning rate, keeping early low level ImageNet features intact while adapting higher level features to the dental domain.
Data Pipeline
    ...
    • Normalization : Used (preprocess_input) from ResNet50, matches the exact normalization that the pretrained weights expect and not a simple /255 rescale normalization style.
